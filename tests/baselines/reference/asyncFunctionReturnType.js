...
async function fGenericIndexedTypeForPromiseOfKProp<TObj extends Obj, K extends keyof TObj>(obj: TObj, key: K): Promise<TObj[K] extends undefined ? TObj[K] : TObj[K] extends PromiseLike<infer U> ? U : TObj[K]> {
    return Promise.resolve(obj[key]);
}

async function fGenericIndexedTypeForExplicitPromiseOfKProp<TObj extends Obj, K extends keyof TObj>(obj: TObj, key: K): Promise<TObj[K] extends undefined ? TObj[K] : TObj[K] extends PromiseLike<infer U> ? U : TObj[K]> {

...
declare namespace ts {
    ...
    interface NegatedType extends Type {
        type: Type;
    }
    enum ObjectFlags {
        Class = 1,
...
declare namespace ts {
    ...
    function createTypeOperatorNode(operator: SyntaxKind.KeyOfKeyword | SyntaxKind.UniqueKeyword | SyntaxKind.ReadonlyKeyword | SyntaxKind.NotKeyword, type: TypeNode): TypeOperatorNode;
